...
@MainActor
final class SoundEffectsMenuItemView: NSView {
    private let iconView = NSImageView()
    private let titleField = NSTextField(labelWithString: "Sound Effects")
    ...
    init() {
        ...
        cancellable = AppState.shared.$soundEffectsEnabled
    ...
    private func setupLayout() {
        ...
        iconView.image = NSImage(systemSymbolName: "speaker.wave.2", accessibilityDescription: nil)
    ...
    private func refresh() {
        stateField.stringValue = AppState.shared.soundEffectsEnabled ? "On" : "Off"
    }
