...
if [[ -n "${USE_APP:-}" ]]; then
    ...
    # the complete Parakeet model / Silero VAD and fail at first launch.
    if [[ ! -f "Models/parakeet-tdt-0.6b-v3/parakeet_vocab.json" \
       || ! -d "Models/parakeet-tdt-0.6b-v3/Encoder.mlmodelc" \
       || ! -f "Models/parakeet-tdt-0.6b-v3/Encoder.mlmodelc/weights/weight.bin" \
