...
Review the final device-size slots in App Store Connect before upload. Replace
these with signed TestFlight captures if the selected storefront slot rejects a
simulator dimension or the final build changes the interface.
