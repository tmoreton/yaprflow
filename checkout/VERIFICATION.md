...
- Vercel deployment: `dpl_G81ESk695gm79CM3jFG4bG4iayrG`
- Deployment URL: `https://yaprflow-checkout-het9y99e2-tmoretons-projects.vercel.app`
- Direct Mac app: Yaprflow 5.2.10, build 23, universal Intel and Apple silicon
- Private installer: `releases/yaprflow-5.2.10.dmg`
- Installer size: 493,898,860 bytes
- Installer SHA-256: `65a716f33ea410f6de8ce641b53fa6f76604dfbfaeda9f1d90b4d55caedb7f51`
...
- The direct app notarization submission ID is `2f474274-e247-4575-8ead-b438b7492aa3`; the DMG submission ID is `b8b2aa6f-3ffd-48af-8ddf-263d9c879197`.
...
- The 5.2.10 direct build compiled as a universal `arm64` and `x86_64` application and contains Sparkle. The iOS Release target also compiled successfully; App Store candidates were not rebuilt for this direct-download maintenance release.
...
- All 63 shared Swift tests passed.

## Sparkle checks

- The direct edition includes Sparkle and requires both archive and feed signatures.
- The first updater-enabled release was 5.1.4. The production feed now offers Mac 5.2.10 build 23 and carries a verified EdDSA feed signature and signed enclosure.
- The private EdDSA key remains outside the repository. The repository contains only the public key.
- The paid 5.2.10 installer stays in the private checkout store. Its byte-identical updater copy is isolated in the unlisted public `yaprflow-sparkle-updates` store under an opaque immutable path and randomized filename. The full public object matches SHA-256 `65a716f33ea410f6de8ce641b53fa6f76604dfbfaeda9f1d90b4d55caedb7f51`.
...
- Production deployment `dpl_G81ESk695gm79CM3jFG4bG4iayrG` is READY and aliased to `https://yaprflow.com/`. Its first-hour error-log scan was clean.
...
- The public page reports software version 5.2.10 and shows the optional newsletter choice.
...
- The active production environment uses `BLOB_PATHNAME=releases/yaprflow-5.2.10.dmg`.
